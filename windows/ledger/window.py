# -*- coding: utf-8 -*-
"""台账面板主窗口：FluentWindow + 左侧导航 + 三个功能页面
...
主界面「写入台账」入口经 open_entry_with_context(ctx) 打开本窗口并
预填当前球桌会话上下文，替代旧的本地 xlsx 追加写入。
"""
...
class LedgerPanelWindow(FluentWindow):
    """台账/问题记录面板：表单录入 + 记录列表/筛选/分页 + 设置"""

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("台账面板")
