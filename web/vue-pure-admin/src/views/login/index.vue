...
// 模板演示入口（手机号/二维码/注册/第三方登录）在生产上没有对应后端，隐藏。
// 需要恢复演示页时把这里改回 true 即可
const showDemoExtras = false;
...
const ruleForm = reactive({
  // 生产环境走售后后端真实账号（users.json + bcrypt），不预填演示口令
  username: "",
  password: "",
  verifyCode: ""
});
      ...
      <div class="login-box">
        <div class="login-form">
          ...
          >
            ...
            <Motion v-if="showDemoExtras" :delay="300">
              <el-form-item>
                <div class="w-full h-5 flex-bc">
                  <el-button
          ...
          <Motion v-if="showDemoExtras && currentPage === 0" :delay="350">
            <el-form-item>
              <el-divider>
